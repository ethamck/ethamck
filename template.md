I have {{s}} total stars on my active projects, where I write

{{l}}

For my personal creations, I always try to use [free & copyleft](https://gnu.org/licenses)<sup>{{lf}}</sup> or [public domain](https://unlicense.org)<sup>{{lp}}</sup> licenses.

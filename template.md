...
I'll only ever use [free & copyleft](https://gnu.org/licenses)<sup>{{f}}</sup> or [public domain](https://unlicense.org)<sup>{{p}}</sup> licenses for any of my personal creations.
